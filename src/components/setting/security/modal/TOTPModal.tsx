      ...
      >
        <div className=" w-[39.72vw] flex flex-col ">
          <div className="w-full flex flex-col gap-[1.12vw] h-[15.01vw] border-t-[0.1vw] border-b-[0.1vw] ">
            <p className=" px-[1.67vw] pt-[1.67vw] text-[0.9722vw] text-[rgba(0,0,0,0.85)]">
          ...
          <div className="w-full h-[3.60vw] flex justify-end items-center gap-[1.6vw] px-[1.12vw] py-[0.69vw] border-b-[0.1vw]">
            <p className="text-[#323E4F] text-[0.9722vw]">
              Got your app open ?
            </p>
            <div
              className="w-[10.07vw] h-[2.22vw] flex items-center justify-center bg-[#1890FF] border-[0.1vw] border-[#1890FF] text-[#fff] text-[0.9722vw] rounded-[0.14vw] cursor-pointer "
          ...
          <div className="flex flex-col h-[5.82vw] px-[1.12vw] py-[0.694vw] gap-[0.56vw]">
            <p className="text-[#323E4F] text-[0.972vw] h-[2.08vw]">
