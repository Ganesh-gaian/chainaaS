  ...
  return (
    <nav className="w-[4vw] h-full flex flex-col items-center justify-between bg-[#222536]">
          ...
          {nav_items.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`h-full rounded-r-[8vw] w-[0.2vw] ${isActive && index !== 0 ? "bg-purple-400" : ""} ${index === 0 ? "hidden" : ""}`}></div>
                {/* Icon background */}
                <div className={`p-[0.5vw] rounded-md ${isActive && index !== 0 ? "bg-[#393B49]" : ""} ${index === 0 ? "bg-[#f5f6f700]" : "p-[0.5vw]"}`}>
                  <Image
      ...
      <div className="w-full">
        <div className="flex flex-col items-center gap-[1vw] *:w-[3vw] *:rounded-[1.5vw] *:bg-[#393B49] ">
