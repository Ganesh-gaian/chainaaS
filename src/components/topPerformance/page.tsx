    ...
    return (
        <div className="p-[1.2vw] flex flex-col gap-[1.4vw] bg-white rounded-sm">
            <div className="w-full flex justify-between items-center">
                <p className="font-medium fs-16 ">Top Performing App</p>
                <Space>
                    <Select
            ...
            <div className="flex gap-[1.2vw] my-[0.4vw]">
                <Image className="w-[3vw]" src={izakLogo} alt="iZakLogo" />
                <div >
                    <p className="font-medium fs-16">{appDetails.name}</p>
                    <p className="opacity-40 fs-12">{appDetails.description}</p>
                </div>
            </div>
            <div className="grid grid-cols-2 ">
                <div className="">
                    <div className="opacity-40 fs-12">Deploment Date</div>
                    <div className="fs-14">{appDetails.deploymentDate}</div>
                </div>
                <div className="">
                    <div className="opacity-40 fs-12">Daily Active Users</div>
                    <div className="fs-16">{`${appDetails.users}+ users per day`}</div>
                </div>
            </div>
            <div className="grid grid-cols-2">
                <div className="">
                    <div className="opacity-40 fs-12">Engagement Rate</div>
                    <div className="fs-14">{appDetails.deploymentDate}</div>
                </div>
                <div className="">
                    <div className="opacity-40 fs-12">Geographic Reach</div>
                    <div className="fs-14">{appDetails.location}</div>
                </div>
            </div>
            <div className="flex gap-[0.4vw] *:fs-12">
                <div className="fs-12">Uptime</div>
                <div className="*:w-[1vw] flex items-center gap-[0.1vw]">
                    ...
                    <p className="text-[#52C41A] fs-12">{`${appDetails.upTime}%`}</p>
                </div>
            </div>
        </div>
    )
