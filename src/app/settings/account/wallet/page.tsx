            ...
            <p className="border-none fs-16 font-medium">Payment Methods</p>
            {
              paymentMethods.map((item, index) => {
                return <div key={index} className="p-[1vw] border-[#D6DAE1] border-[0.01vw] flex justify-between gap-[1vw] tetx-[#323E4F] rounded-lg">
                  ...
                  {/* Action Icons */}
                  <div className="flex gap-[1vw] *:w-[2.4vw] *:aspect-square *:flex *:justify-center *:items-center">
                    <button className="border border-gray-300 p-[0.4vw] rounded-[0.4vw] hover:border-gray-400 transition-colors">
